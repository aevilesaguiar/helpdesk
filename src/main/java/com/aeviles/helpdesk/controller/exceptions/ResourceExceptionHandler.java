package com.aeviles.helpdesk.controller.exceptions;
...
public class ResourceExceptionHandler {
    ...
    //manipulador de exceções para o object notFound
    @ExceptionHandler(ObjectNotFoundException.class)//manipulando exceção dessa Classe
    ...
    @ExceptionHandler(DataIntegrityViolationException.class)//manipulando exceção dessa Classe
    ...
    @ExceptionHandler(MethodArgumentNotValidException.class)//manipulando exceção dessa Classe
